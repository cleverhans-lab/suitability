...
for data in datasets:
    ...
    with open(job_file, 'w+') as fh:
        ...
        fh.writelines(f"python wilds/examples/run_expt.py --dataset {data} --algorithm ERM --root_dir /mfsnic/u/apouget/data/ --log_dir /mfsnic/u/apouget/experiments/{data} --use_wandb --wandb_api_key_path /h/321/apouget/wandb_key.txt --wandb_kwargs project=WILDS name={data} \n")
