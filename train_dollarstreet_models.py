...
with open(job_file, 'w+') as fh:
    ...
    fh.writelines(f"python dollarstreet_model.py --root_dir /mfsnic/u/apouget/data/dollarstreet/dataset_dollarstreet/ --log_dir /mfsnic/u/apouget/experiments/dollarstreet_fewer_epochs_2 --use_wandb --wandb_api_key_path /h/321/apouget/wandb_key.txt --wandb_kwargs project=DollarStreet name=initial --batch_size 32 --epochs 40 --lr 0.1 --momentum 0.9 --weight_decay 1e-4 --lr_step_size 30 --lr_gamma 0.1 \n")
